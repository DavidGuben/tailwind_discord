              ...
              <div className="group-active:translate-y-px">
                <div className={`${
                  router.pathname === "/"
                    ...
                    : "hover:bg-brand hover:text-white hover:rounded-2xl text-gray-100 bg-gray-700 rounded-3xl"
                  }  w-12 h-12 flex items-center justify-center duration-200 transition-all`}
                  >
